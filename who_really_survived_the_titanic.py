...
## "Extra Credit" Titanic Survival Simulator
"""
...
text_width = 40
print("=" * text_width)
print(f"{'TITANIC SURVIVAL PREDICTOR':^{text_width}}")
print("=" * text_width)
...
age = widgets.IntText(value=25, description='Age:')
fare = widgets.FloatText(value=15.0, description='Fare:')
embarked = widgets.Dropdown(options=['Southampton', 'Cherbourg', 'Queenstown'], value='Southampton', description='Embarked:')
...
def on_button_click(b):
    with output:
        ...
        prediction = random_forest_model.predict(passenger)[0]
        probability = random_forest_model.predict_proba(passenger)[0][1] * 100

        if prediction == 1:
            print("\n" + "Congratulations, you (probably) survived the Titanic!")
        else:
            print("\n" + "You died!")

        print(f"Survival probability: {probability:.1f}%")

button.on_click(on_button_click)

display(pclass, sex, age, fare, embarked, button, output)